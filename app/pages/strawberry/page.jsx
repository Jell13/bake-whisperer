      ...
      <div className=' flex flex-col'>
        ...
        <div className='w-full flex md:flex-row flex-col gap-8 px-8'>
          ...
          <div className='flex flex-col md:py-48 text-walnut'>
            ...
            <br />
            <div className='flex flex-col'>
              <p className='font-Open tracking-tighter max-w-[20rem] md:max-w-full text-xl'>A light, soft, and airy chiffon cake filled with strawberry confit, fresh cream, and strawberry slices</p>
