...
const page = () => {
    const slides = ["/banoffee1.jpg", "/banoffee2.jpg", "/banoffee.jpg"];
            ...
            <div className=" flex flex-col">
                ...
                <div className="w-full flex md:flex-row flex-col gap-8 px-8">
                    ...
                    <div className="flex flex-col md:py-48 text-walnut">
                        ...
                        <br />
                        <div>
                            <p className="font-Open tracking-tighter max-w-[40rem] md:max-w-full text-xl">A light, soft, and airy chocolate chiffon cake filled with salted caramel, fresh cream, and banana</p>
